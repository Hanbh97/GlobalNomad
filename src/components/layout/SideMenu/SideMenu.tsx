...
const SideMenu = () => {
  ...
  return (
    <>
      ...
      <nav
        className={`fixed top-[15%] left-0 z-115 md:z-50 w-55 px-3.5 py-6 flex justify-center items-center gap-6 bg-white border border-gray-50 rounded-r-xl shadow-[0_4px_24px_rgba(156,180,202,0.2)] transition-transform duration-300
